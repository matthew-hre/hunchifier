        ...
        <div className="grid gap-6">
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="flex flex-col">
              ...
              <CardContent>
                <LineChart className="aspect-[4/3]" data={hourlyData} charttype={'hourly'} />
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
    ...
    <div {...props}>
      <ResponsiveLine
        ...
        tooltip={({ point }) => (
          ...
          >
            <div><strong>{point.serieId}</strong></div> {/* Display the legend */}
...
const CustomTickComponent = ({ x, y, value }: { x: number, y: number, value: any }) => {
  ...
  return (
    <>
      ...
      <text x={x} y={y + 40} textAnchor="middle" style={{ fontSize: 12, fontWeight: 'bold' }}>
        {dateStr}
      </text>
    </>
  );
